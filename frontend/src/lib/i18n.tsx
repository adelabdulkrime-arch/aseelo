...
const STRINGS = {
  ...
  captionsHint: {
    ar: "اسحب الشريط لتحريك النص، واسحب طرفيه لتغيير مدته.",
    en: "Drag a bar to move it, drag its edges to change how long it shows.",
  },
  captionsRequired: {
  ...
  qualityFast: { ar: "سريع", en: "Fast" },
  qualityBalanced: { ar: "متوازن", en: "Balanced" },
  qualityHigh: { ar: "عالية", en: "High" },
  qualityFastHint: { ar: "٧٢٠p — أسرع معالجة وأصغر حجم", en: "720p - fastest, smallest file" },
  qualityBalancedHint: { ar: "١٠٨٠p — الخيار الموصى به", en: "1080p - recommended" },
  qualityHighHint: { ar: "١٠٨٠p بجودة أعلى — معالجة أبطأ", en: "1080p, sharper - slower to render" },
  maxDurationHint: {
