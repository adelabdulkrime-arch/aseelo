...
const STRINGS = {
  ...
  secondsShort: { ar: "ث", en: "s" },
  addCaption: { ar: "إضافة نص", en: "Add caption" },
  untitledCaption: { ar: "نص بلا محتوى", en: "Empty caption" },
  captionTextPlaceholder: { ar: "اكتب النص الذي يظهر…", en: "Text to show…" },
  band_top: { ar: "أعلى", en: "Top" },
  band_center: { ar: "وسط", en: "Middle" },
  band_bottom: { ar: "أسفل", en: "Bottom" },
  animFade: { ar: "ظهور تدريجي", en: "Fade" },
  animZoomFade: { ar: "تكبير وظهور", en: "Zoom + fade" },
  animSlideUp: { ar: "انزلاق للأعلى", en: "Slide up" },
  animNone: { ar: "بلا حركة", en: "None" },
  captionsHint: {
    ar: "اسحب الشريط لتحريك النص، واسحب طرفيه لتغيير مدته — أو اضبط الثواني بالأرقام بالأسفل.",
    en: "Drag a bar to move it, drag its edges to resize it - or set the seconds exactly below.",
  },
  captionFrom: { ar: "من (ثانية)", en: "From (s)" },
  captionTo: { ar: "إلى (ثانية)", en: "To (s)" },
  captionDuration: { ar: "المدة", en: "Duration" },
  captionsRequired: {
    ar: "أضف نصاً واحداً على الأقل مع محتوى.",
    en: "Add at least one caption with text.",
  },
  // ---- output quality ----
  quality: { ar: "الجودة", en: "Quality" },
  qualityFast: { ar: "منخفضة", en: "Low" },
  qualityBalanced: { ar: "متوسطة", en: "Medium" },
  qualityHigh: { ar: "عالية", en: "High" },
  qualityFastHint: { ar: "480p — أسرع معالجة وأصغر حجم", en: "480p - fastest, smallest file" },
  qualityBalancedHint: { ar: "720p — الخيار الموصى به", en: "720p - recommended" },
  qualityHighHint: { ar: "1080p — أوضح، معالجة أبطأ", en: "1080p - sharpest, slower to render" },
  maxDurationHint: {
  ...
  removeWhiteBackground: { ar: "إزالة خلفية الشعار", en: "Remove the logo background" },
  removeWhiteBackgroundHint: {
    ar: "يتعرّف على لون الخلفية تلقائياً — أبيض كان أو غيره. قد يزيل نفس اللون داخل التصميم.",
    en: "Detects the backdrop colour automatically, white or not. It may also clear that same colour inside the design.",
  },
  logoCutoutApplied: {
    ar: "تمت إزالة خلفية شعارك.",
    en: "Your logo's background was removed.",
  },
